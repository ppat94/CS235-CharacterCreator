...
class VolundMultiStandardShaderGUI : ShaderGUI
{
	...
	MaterialProperty emissionTemperature = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		emissionTemperature = FindProperty ("_EmissionTemperature", props, false);
	...
	{
		return color.grayscale > (0.05f / 255.0f); // (0.1f / 255.0f) is not small enough
	}
